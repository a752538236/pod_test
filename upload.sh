...
#获取版本号并显示
VersionString=`grep -E 's.version.*=' pod_test.podspec`
...
LineNumber=`grep -nE 's.version.*=' pod_test.podspec | cut -d : -f1`
sed -i "" "${LineNumber}s/${VersionNumber}/${NewVersionNumber}/g" pod_test.podspec
echo -e "\n${Default}================================================"
...
pod repo update Specs && pod repo push Specs pod_test.podspec --verbose --allow-warnings --sources='https://github.com/a752538236/Spec.git,https://github.com/CocoaPods/Specs'
